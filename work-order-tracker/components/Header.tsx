...
export default function Header({
  ...
  return (
    ...
    >
      ...
      {showExportModal && (
        <div className="modal-overlay fixed inset-0 z-[60] flex items-end md:items-center justify-center p-0 md:p-4" style={{ background: 'rgba(0,0,0,0.7)' }}>
                  ...
                  {['CSV','EXCEL','PDF'].map(f => (
                    <button
                      ...
                      style={exportConfig.format === f
                        ? { background: 'var(--cta-bg)', color: 'var(--cta-text)', border: '1px solid var(--accent-border)', boxShadow: 'var(--shadow-sm)' }
