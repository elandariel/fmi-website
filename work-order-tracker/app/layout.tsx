...
function SidebarItem({
  ...
  return (
    <Link href={href} onClick={onClick}>
      <div className={`
        relative flex items-center gap-3 rounded-xl transition-all duration-200 text-[13px] font-medium mb-0.5 group
        ${collapsed ? 'justify-center w-10 h-10 mx-auto' : 'px-3 py-2.5'}
        ${isActive
          ? 'text-white'
          : 'text-[#6b7a96] hover:text-[#c8d6e8]'
        }
      `}>
        ...
        {collapsed && (
          <div
            className="absolute left-full ml-3 px-3 py-1.5 text-white text-xs font-semibold rounded-lg opacity-0 group-hover:opacity-100 pointer-events-none whitespace-nowrap z-50 transition-all duration-150"
            style={{
          ...
          >
            {label}
            <div className="absolute right-full top-1/2 -translate-y-1/2 border-4 border-transparent border-r-[rgba(13,21,36,0.95)]" />
          </div>
        )}
      </div>
    </Link>
  ...
  return (
    <html lang="id" data-theme={theme}>
      <body
        ...
        style={{ fontFamily: "'Inter', sans-serif", background: 'var(--bg-base)', color: 'var(--text-primary)' }}
      >
        <Toaster
          richColors
          position="top-center"
          ...
          <>
            ...
            >
                ...
                <Link href="/" className="flex items-center gap-3 min-w-0 group" onClick={closeSidebarOnMobile}>
                  ...
                  {!collapsed && (
                    <div className="min-w-0">
                      <h1
                        className="font-black text-[15px] tracking-tight leading-none text-white"
                      ...
                      <p
                        ...
                        style={{ fontSize: 9, letterSpacing: '0.14em', color: 'rgba(255,255,255,0.2)', textTransform: 'uppercase' }}
                      >
                        Network Operations
                      </p>
                    </div>
              ...
              >
                ...
                <SidebarItem collapsed={collapsed} onClick={closeSidebarOnMobile} href="/work-orders" icon={<ClipboardList size={16} />}   label="Monthly Report" />
                <SidebarItem collapsed={collapsed} onClick={closeSidebarOnMobile} href="/tracker"     icon={<LineChart size={16} />}       label="Weekly Report" />
