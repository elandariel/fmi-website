          ...
          <>
            ...
            `}>
              ...
              <nav className="flex-1 p-4 space-y-2 overflow-y-auto custom-scrollbar overflow-x-hidden">
                <p className={`px-4 text-[10px] font-bold text-slate-500 uppercase mb-2 mt-2 tracking-widest truncate ${!sidebarOpen && 'md:hidden'}`}>Database</p>
                ...
                <SidebarItem onClick={closeSidebarOnMobile} href="/interkoneksi" icon={<Activity size={20} />} label="Data Interkoneksi" />
